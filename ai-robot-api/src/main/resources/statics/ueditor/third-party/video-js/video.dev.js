...
================================================================================ */
/**
 * The enums functionality for sliders like the volume bar and seek bar
 *
 * @param {vjs.Player|Object} player
 * @param {Object=} options
 * @constructor
...
vjs.Player = vjs.Component.extend({
  ...
  init: function(tag, options, ready){
    ...
    // Run enums component initializing with new options.
...
/**
 * The enums class for all text tracks
 *
...
/**
 * The enums class for buttons that toggle specific text track types (e.g. subtitles)
 *
 * @constructor
 */
